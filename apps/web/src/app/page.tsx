...
import {
  ...
  ArrowRight, Terminal, ShieldCheck, TrendingUp, Settings, Download, FileText, ShieldAlert,
} from 'lucide-react';
              ...
              <div className="m-4 mb-0 rounded-2xl border border-amber-500/30 bg-amber-500/5 animate-fade-in overflow-hidden">
                ...
                <div className="flex items-center gap-3 px-4 py-3 border-b border-amber-500/20 bg-amber-500/10">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-amber-400/70 mt-0.5">The agent wants to perform a write or destructive operation</p>
                  </div>
